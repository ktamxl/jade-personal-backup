...
w("""<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Restaurants — Tam Family China 2026</title>
<style>
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
:root{--sh:#1a6880;--zj:#5a8a3a;--sz:#c04a0c;--gold:#c9a84c;--w:#fff;--soft:#f5f2ec}
body{font-family:Georgia,'Times New Roman',serif;background:#f5f2ec;color:#1a1a2e;line-height:1.7}
...
.hero h1{font-size:clamp(1.6rem,5vw,2.6rem);font-weight:normal;margin-bottom:6px}
...
.hs .v{font-size:1.4rem;font-weight:bold;color:var(--gold);display:block;font-family:sans-serif}
.hs .l{font-size:.65rem;opacity:.65;text-transform:uppercase;letter-spacing:.1em;font-family:sans-serif}
...
.ctab{padding:10px 24px;border-radius:40px;font-family:sans-serif;font-size:.85rem;text-decoration:none;font-weight:bold;color:#fff;display:inline-flex;align-items:center;transition:all .25s}
.ctab:hover{transform:translateY(-2px);box-shadow:0 6px 20px rgba(0,0,0,.2)}
.ctab.sh{background:var(--sh)}
.ctab.zj{background:var(--zj)}
.ctab.sz{background:var(--sz)}
.sb{max-width:900px;margin:0 auto;padding:0 24px 48px}
.sb h2{font-size:1.6rem;font-weight:normal;margin-bottom:8px}
.sb p{font-size:.88rem;opacity:.6;margin-bottom:28px;font-family:sans-serif}
...
.cn{display:flex;flex-direction:column;align-items:center;justify-content:center;color:#fff;font-family:sans-serif;padding:16px 8px;text-align:center;min-height:100px}
.ce{font-size:1.5rem;display:block}
.cl{font-size:.55rem;opacity:.7;text-transform:uppercase;letter-spacing:.05em;margin-top:4px}
.cb{padding:16px 18px 14px 14px}
.cb h3{font-size:1.05rem;font-weight:normal;margin-bottom:4px}
.cchi{font-size:.75rem;font-family:sans-serif;margin-bottom:8px}
...
.ctgs{display:flex;flex-wrap:wrap;gap:5px}
...
<body>
<div class="hero">
  <div class="hero-badge">Tam Family China 6 2026</div>
  <h1>Restaurants</h1>
  <p class="hero-sub">Top 10 must-eat restaurants across Shanghai &middot; Zhujiajiao &middot; Shenzhen</p>
  <div class="hero-stats">
    ...
    <div class="hs"><span class="v">Nov 23 &ndash; Dec 1</span><span class="l">Dates</span></div>
  </div>
</div>
...
<div class="ctabs">
  <a href="#shanghai" class="ctab sh">Shanghai</a>
  <a href="#zhujiajiao" class="ctab zj">Zhujiajiao</a>
  <a href="#shenzhen" class="ctab sz">Shenzhen</a>
</div>
""")
OUT.close()
